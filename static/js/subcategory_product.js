window.addEventListener("DOMContentLoaded", () => {
    ...
    shopPriceFilterBtn.addEventListener("click", () => {
        ...
        // Getting subcategory title
        let subcategoryTitle = currentLoc.split("product/subcategory/");
        subcategoryTitle = subcategoryTitle[1].split("/")[0]; // Returns subcategory title
        ...
        window.location.href = `/product/subcategory/${subcategoryTitle}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${size !== null ? size : "none"}/sort=${sortWay !== null ? sortWay : "default"}/`;
    })
    ...
    shopProductSelectSortWay.addEventListener("change", (e) => {
        ...
        // Navigate to category products filter page
        window.location.href = `/product/subcategory/${subcategoryTitle}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${size !== null ? size : "none"}/sort=${sortWay}/`;
    })
})
...
const shopProductColorSelect = (e) => {
    ...
    if (colorTitle) {
        ...
        // Navigate to category products filter page
        window.location.href = `/product/subcategory/${subcategoryTitle}/price=${minPrice},${maxPrice}/color=${colorTitle}/size=${size !== null ? size : "none"}/sort=${sortWay !== null ? sortWay : "default"}/`;
    }
}
...
const shopProductSizeSelect = (e) => {
    ...
    if (sizeTitle) {
        ...
        // Navigate to category products filter page
        window.location.href = `/product/subcategory/${subcategoryTitle}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${sizeTitle}/sort=${sortWay !== null ? sortWay : "default"}/`;
    }
}