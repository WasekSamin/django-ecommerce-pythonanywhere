window.addEventListener("DOMContentLoaded", () => {
    ...
    shopPriceFilterBtn.addEventListener("click", () => {
        ...
        const searchText = currentLoc.split("product/search/q=")[1].split("/")[0];
        ...
        // Navigate to shop products filter page
        window.location.href = `/product/search/q=${searchText}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${size !== null ? size : "none"}/sort=${sortWay !== null ? sortWay : "default"}/`;
    })
    ...
    shopProductSelectSortWay.addEventListener("change", (e) => {
        ...
        // Navigate to shop products filter page
        window.location.href = `/product/search/q=${searchText}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${size !== null ? size : "none"}/sort=${sortWay}/`;
    })
})
...
const shopProductColorSelect = (e) => {
    ...
    if (colorTitle) {
        ...
        // Navigate to shop products filter page
        window.location.href = `/product/search/q=${searchText}/price=${minPrice},${maxPrice}/color=${colorTitle}/size=${size !== null ? size : "none"}/sort=${sortWay !== null ? sortWay : "default"}/`;
    }
}
...
const shopProductSizeSelect = (e) => {
    ...
    if (sizeTitle) {
        ...
        // Navigate to shop products filter page
        window.location.href = `/product/search/q=${searchText}/price=${minPrice},${maxPrice}/color=${color !== null ? color : "none"}/size=${sizeTitle}/sort=${sortWay !== null ? sortWay : "default"}/`;
    }
}